...
\end{itemize}
Experimental results show that RRAM based design saves $18\%$ system energy with a $15\%$ smaller on-chip RAM area compared with SRAM design. Introducing RRAM as on-chip buffer, the total energy cost of the system is reduced by $18\%$ compared with the optimal SRAM design.
